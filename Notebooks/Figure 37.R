...
p1 <- ggplot(fineware_steps1,aes(x=DAT_step, colour=variable), show.legend = FALSE) + geom_density(bw=5, aes(y = after_stat(count)), size=1.0, alpha = 0.25,) + Plot_Theme + Plot_Scale + scale_colour_manual(name  ="Provenance", labels = c("Adriatic Littoral", "Central Italy", "Eastern Mediterranean", "Gaul", "North Africa", "Northern Italy"), values = c("steelblue2", "gold3", "indianred4", "darkorange3", "#81A88D", "mediumpurple4")) + labs(y="Frequency", legend="Provenance", title="Production Dates", subtitle = "A - Quantities", legend="Provenance", attributes(fineware)$source,sep="") + theme(legend.position = "none")
...
### Breakdown of Distribution by Provenance ###
p2 <- ggplot(fineware_steps2,aes(x=DAT_step, colour=variable)) + geom_density(bw=5, aes(y = after_stat(count)), size=1.0, alpha = 0.25,) + Plot_Theme + Plot_Scale + scale_colour_manual(name  ="Provenance", labels = c("Adriatic Littoral", "Central Italy", "Eastern Mediterranean", "Gaul", "North Africa", "Northern Italy"), values = c("steelblue2", "gold3", "indianred4", "darkorange3", "#81A88D", "mediumpurple4")) + labs(y="", title = "Deposition Dates", legend="Provenance", subtitle="B - Quantities", legend="Provenance", attributes(fineware)$source,sep="") 
...
fineware3 <- fineware3[fineware3$Provenance_1 != "Not_Available", ]
...
p3 <- ggplot(fineware_steps3,aes(x=DAT_step, colour=variable), show.legend = FALSE) + geom_density(bw=5, aes(y = after_stat(count)), size=1.0, alpha = 0.25,) + Plot_Theme + Plot_Scale + scale_colour_manual(name  ="Provenance", labels = c("Adriatic Littoral", "Central Italy", "Eastern Mediterranean", "Gaul", "North Africa", "Northern Italy"), values = c("steelblue2", "gold3", "indianred4", "darkorange3", "#81A88D", "mediumpurple4")) + labs(y="Frequency", legend="Provenance", subtitle = "C - Diversity", legend="Provenance", attributes(fineware)$source,sep="") + theme(legend.position = "none")
...
fineware4 <- fineware4[fineware4$Provenance_1 != "Not_Available", ]
...
### Breakdown of Distribution by Provenance ###
p4 <- ggplot(fineware_steps4,aes(x=DAT_step, colour=variable), show.legend = FALSE) + geom_density(bw=5, aes(y = after_stat(count)), size=1.0, alpha = 0.25,) + Plot_Theme + Plot_Scale + scale_colour_manual(name  ="Provenance", labels = c("Adriatic Littoral", "Central Italy", "Eastern Mediterranean", "Gaul", "North Africa", "Northern Italy"), values = c("steelblue2", "gold3", "indianred4", "darkorange3", "#81A88D", "mediumpurple4")) + labs(y="", legend="Provenance", subtitle = "D - Diversity", legend="Provenance", attributes(fineware)$source,sep="") 
